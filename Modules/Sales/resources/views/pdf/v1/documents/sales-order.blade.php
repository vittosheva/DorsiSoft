...
@section('title', __('Sales order') . ' ' . $document->code)
@section('doc-type', __('Sales order'))
        ...
        <tr>
            ...
            <td class="billing-right">
                <table class="detail-table">
                    ...
                    @if($document->quotation?->code)
                        <tr>
                            <td class="detail-key">{{ __('Quotation') }}</td>
                            <td class="detail-val">{{ $document->quotation->code }}</td>
                        </tr>
                    @endif
